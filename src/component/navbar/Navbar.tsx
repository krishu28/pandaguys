      ...
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        >
            ...
            {navigation?.map((item) => {
              ...
              return (
                <div
                  ...
                  onMouseLeave={() => hasSubmenu && setOpenSubmenu({})}
                >
                  <Link
                    to={item.href}
                  ...
                  {hasSubmenu && openSubmenu === item.name && (
                    <div className="absolute left-0 mt-2 rounded-sm w-80 bg-gray-200">
                      <div className="flex justify-around p-2">
                        {item.submenu.map((subItem) => (
                          <Link
                            key={subItem.name}
                            to={subItem.href}
                            className="text-gray-800 px-4 py-2 hover:bg-gray-300 rounded"
                          >
                            {subItem.name}
                          </Link>
                        ))}
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <Link
              to="#"
              className="text-md bg-gray-100 rounded-md p-3 font-semibold leading-6 text-gray-900"
            >
                        ...
                        <div className="flex justify-around pl-4">
                          {item.submenu.map((subItem) => (
                            <Link
                              key={subItem.name}
                              to={subItem.href}
                              className="block py-2 text-gray-800 hover:bg-gray-300 rounded px-3"
                            >
                              {subItem.name}
                            </Link>
                          ))}
